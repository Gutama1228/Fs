...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "2006138083"))
...
# Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://root:root@cluster0.nm9r8fx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1002047062577"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1001674494092"))
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1001674494092"))
FORCE_SUB_CHANNEL4 = int(os.environ.get("FORCE_SUB_CHANNEL4", "-1002040495578"))
